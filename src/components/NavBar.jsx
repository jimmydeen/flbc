			...
			<Toolbar disableGutters>
				...
				<Box sx={{ flexGrow: 1, display: 'flex', gap: 3 }}>
						...
						<div
							sx={{ my: 2, display: 'block', color: 'black' }}
						>
							<NavLink to="/viewRequests" style={({ isActive, isPending, isTransitioning }) => { return {textDecoration: 'none', fontSize: '1.5em', color: isActive ? "black" : "blue"}}}>View the Requests</NavLink>
						</div>
				</Box>
			</Toolbar>
		</Container>
